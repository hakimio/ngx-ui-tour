...
# [9.0.0](https://github.com/hakimio/ngx-ui-tour) (2026-06-19)
...
# [8.0.0](https://github.com/hakimio/ngx-ui-tour) (2026-02-03)
...
- `TourIonPopoverModule` module has been removed. Use `TourIonPopover` standalone component bundle instead.
- `NgModule` based applications are no longer officially supported and `TourIonPopover` standalone component bundle can
...
- Decorated `@Input()` properties have been replaced with `signal` input properties. Writing to inputs directly will no
  longer work. Instead, you can use [`ComponentRef.setInput()`](https://angular.dev/api/core/ComponentRef#setInput), 
