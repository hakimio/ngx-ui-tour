(function () {
  ...
  (self["webpackChunkngx_ui_tour"] = self["webpackChunkngx_ui_tour"] || []).push([["src_app_ng-bootstrap_ng-bootstrap_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      function DocsComponent_tr_306_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DocsComponent_td_309_Template(rf, ctx) {
        if (rf & 1) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _NgBootstrapComponent = /*#__PURE__*/function () {
        function _NgBootstrapComponent(tourService) {
          _classCallCheck(this, _NgBootstrapComponent);

          this.tourService = tourService;
        }

        _createClass(_NgBootstrapComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.tourService.initialize([{
              anchorId: 'start.tour',
