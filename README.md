...
| **nextOn** | string | undefined |	Use this to wait for certain event on step target before going to the next step like click on a button or hit enter on an input. |
