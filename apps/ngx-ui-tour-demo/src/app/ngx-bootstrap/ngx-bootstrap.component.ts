import type {IStepOption} from 'ngx-ui-tour-ngx-bootstrap';
import {TourAnchorNgxBootstrapDirective, TourNgxBootstrapModule, TourService} from 'ngx-ui-tour-ngx-bootstrap';
...
export default class NgxBootstrapComponent implements OnInit {
