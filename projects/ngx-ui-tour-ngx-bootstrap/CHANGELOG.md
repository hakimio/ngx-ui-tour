...
# [12.0.3](https://github.com/hakimio/ngx-ui-tour) (2024-01-25)
...
### Features
- Support for Angular 15 and Ngx Bootstrap 10
...
### Breaking changes
- `TourNgxBootstrapModule.forRoot()` method was removed since all services are now provided in "root". Now only the 
...
### Features
- Support for Angular 14 and Ngx Bootstrap 9
